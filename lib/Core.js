...
// ---------------------------------------------------------------------------------------------------------------------
    ...
    var loaderFactory = function (cacheObject, method, format, self, type) {
        ...
        return function (name) {
            ...
            if (type === 'module') {
                method.call(self, path, successOrFail);
            } else if (type === 'template') {
                method.call(self, path, successOrFail, 'html').error(successOrFail);
            } else {
                method.call(self, path, successOrFail).error(successOrFail);
            }
            return dfd.promise();
        }
    };
