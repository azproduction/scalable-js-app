...
// ---------------------------------------------------------------------------------------------------------------------
     ...
     */
    var CorePublic = {
        trigger:        EventManager.trigger.bind(EventManager),
        bind:           EventManager.bind.bind(EventManager),
        unbind:         EventManager.trigger.bind(EventManager),
        on:             EventManager.bind.bind(EventManager),

        getModule:      ModuleManager.getModule.bind(ModuleManager),
        getDescriptor:  ModuleManager.getDescriptor.bind(ModuleManager),
        pushDescriptor: ModuleManager.pushDescriptor.bind(ModuleManager),
        pushModule:     ModuleManager.pushModule.bind(ModuleManager),

        init:           Core.init.bind(Core),
        destroyModule:  Core.destroyModule.bind(Core),
        initModule:     Core.initModule.bind(Core)
    };        
